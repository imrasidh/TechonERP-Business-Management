...
import { DownloadLink, useDownloadUrl } from "./config/releaseManifest.jsx";
  ...
  return (
    <nav style={{position:"fixed",top:0,left:0,right:0,zIndex:50,
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between" style={{height:72}}>
        ...
        {/* CTA */}
        <DownloadLink target="_blank" rel="noreferrer"
        ...
        <div style={{background:"white",margin:"0 12px 12px",borderRadius:16,
          ...
          <DownloadLink target="_blank" rel="noreferrer"
            style={{display:"block",textAlign:"center",marginTop:8,padding:"12px",
              ...
              fontWeight:700,borderRadius:12,fontSize:"0.875rem"}}><svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"/><polyline points="7 10 12 15 17 10"/><line x1="12" y1="15" x2="12" y2="3"/></svg> Download Free Trial</DownloadLink>
        </div>
      )}
    </nav>
  );
      ...
      <div className="lg:grid lg:grid-cols-2 lg:gap-12 lg:items-center">
        <div className="text-center lg:text-left">
          ...
          <div className="flex flex-col sm:flex-row justify-center lg:justify-start gap-3">
            <DownloadLink target="_blank" rel="noreferrer" className="btn-primary">
      ...
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-5 items-stretch">
        {plans.map((p,i)=>(
          <div key={i}
            ...
            <a href={p.isFree ? downloadUrl : site.whatsappPrefill("I want to purchase TechonERP")} target="_blank" rel="noreferrer"
